...
CHR=$1
# directorios
ROOT_DIR="data_processing/16_phase_and_imputation/"
DATA_DIR="resources/1000G/1000GP_Phase3/"
RESULTS_DIR="results/16_phase_and_imputation/"
...
GWASDATA_BED="data_processing/16_phase_and_imputation/LACRN-chr${CHR}.bed"
GWASDATA_BIM="data_processing/16_phase_and_imputation/LACRN-chr${CHR}.bim"
GWASDATA_FAM="data_processing/16_phase_and_imputation/LACRN-chr${CHR}.fam"
# output
OUTPUT_HAPS="results/16_phase_and_imputation/LACRN-chr${CHR}.haps"
OUTPUT_SAMPLE="results/16_phase_and_imputation/LACRN-chr${CHR}.sample"
OUTPUT_LOG="results/16_phase_and_imputation/LACRN-chr${CHR}.log"
