...
CHR=$1
# directorios
ROOT_DIR="data_processing/20_phase_impute_PATAGONIA/"
DATA_DIR="resources/1000G/1000GP_Phase3/"
RESULTS_DIR="results/20_phase_impute_PATAGONIA/"
...
GWASDATA_BED="data_processing/20_phase_impute_PATAGONIA/PATAGONIA-chr${CHR}.bed"
GWASDATA_BIM="data_processing/20_phase_impute_PATAGONIA/PATAGONIA-chr${CHR}.bim"
GWASDATA_FAM="data_processing/20_phase_impute_PATAGONIA/PATAGONIA-chr${CHR}.fam"
# output
OUTPUT_HAPS="results/20_phase_impute_PATAGONIA/PATAGONIA-chr${CHR}.haps"
OUTPUT_SAMPLE="results/20_phase_impute_PATAGONIA/PATAGONIA-chr${CHR}.sample"
OUTPUT_LOG="results/20_phase_impute_PATAGONIA/PATAGONIA-chr${CHR}.log"
