...
CHR=$1
# directorios
ROOT_DIR="data_processing/22_IMPUTAR_LACRN_1000G_AMR/"
...
GWASDATA_BED="data_processing/22_IMPUTAR_LACRN_1000G_AMR/AMR_REFERENCE-IMPUTED-chr${CHR}.bed"
GWASDATA_BIM="data_processing/22_IMPUTAR_LACRN_1000G_AMR/AMR_REFERENCE-IMPUTED-chr${CHR}.bim"
GWASDATA_FAM="data_processing/22_IMPUTAR_LACRN_1000G_AMR/AMR_REFERENCE-IMPUTED-chr${CHR}.fam"
# output
OUTPUT_HAPS="results/22_IMPUTAR_LACRN_1000G_AMR/AMR_REFERENCE-IMPUTED-chr${CHR}.haps"
OUTPUT_SAMPLE="results/22_IMPUTAR_LACRN_1000G_AMR/AMR_REFERENCE-IMPUTED-chr${CHR}.sample"
OUTPUT_LOG="results/22_IMPUTAR_LACRN_1000G_AMR/AMR_REFERENCE-IMPUTED-chr${CHR}.log"
